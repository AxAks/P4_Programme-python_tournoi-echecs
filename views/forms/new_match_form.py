...
from views.inputs.generic_inputs import integer_to_float, ask_integer
...
class NewMatchForm(Form):
    ...
    def ask_player_1_score(self):  # pour le player1, puis pour le player 2
        """
    ...
    def ask_player_2_score(self):  # pour le player1, puis pour le player 2
        """
