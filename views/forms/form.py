...
class Form(Menu):
    ...
    def add_new(self,) -> dict:   # essayer de rendre add_new_tournament et add_new_player générique !! cf ask_obj_property() dans class Player_Inputs
        ...
        for _property in properties:
            properties_dict[_property] = GenericInput().ask_property()
